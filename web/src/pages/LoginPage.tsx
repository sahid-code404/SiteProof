...
export function LoginPage() {
  ...
  return (
    <main className="login-page">
      <section className="login-visual" aria-label="SiteProof verification overview">
        <div className="login-copy">
          ...
          <div className="signal-grid" aria-label="Verification workflow"><span>01 · Location</span><span>02 · Assignment</span><span>03 · Audit</span><span>04 · Readiness</span></div>
        </div>
      </section>
