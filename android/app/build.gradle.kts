...
android {
    ...
    buildTypes {
        getByName("debug") {
            ...
            // Current Fedora redesign backend. The resolver still prefers adb reverse first and
            // automatically falls back to normal LAN discovery if this address is unreachable.
            buildConfigField(
                "String",
                "SITEPROOF_DEV_BACKEND_URL",
